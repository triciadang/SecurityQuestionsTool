...
def main():
    ...
    questions_list = ["What is your favorite food?"," Who is your favorite actor of all time?","Who is your all-time favorite author?","Who is your favorite cartoon character?","What was the first concert you attended?","What would you like your nickname to be?","What city would you most like to visit?","What was the model of the first car you drove?"]
    ...
    print("Welcome to the Security Question Answer Finder!")
    twitter_username = input("Enter username to scan: ")
    question_bank = input("Enter question bank: ")
